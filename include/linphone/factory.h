...
/**
 * Instantiate a #LinphoneCore object. // TODO PAUL: handle documentation
 *
 * The #LinphoneCore object is the primary handle for doing all phone actions. It should be unique within your
 * application.
 * The #LinphoneCore object is not started automatically, you need to call linphone_core_start() to that effect.
 ...
 * @see linphone_core_new_with_config_3 // TODO PAUL : what?
 */
...
/**
 * Instantiate a #LinphoneCore object with a given LinphoneConfig.// TODO PAUL: handle documentation
 *
 * The #LinphoneCore object is the primary handle for doing all phone actions. It should be unique within your
 * application.
 * The #LinphoneCore object is not started automatically, you need to call linphone_core_start() to that effect.
 ...
 * @param[in] app_group Name of iOS App Group that lead to the file system that is shared between an app and its app extensions.
 * @param[in] main_core Indicate if we want to create a "Main Core" or an "Executor Core". // TODO PAUL: ok?
 * @see linphone_factory_create_core_3// TODO PAUL : what?
 */
